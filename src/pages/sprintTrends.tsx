...
export default function SprintTrendsPage() {
    ...
    return (
        <SidebarDrawerProvider>
            <Head>
                <title>Sprint Trends | Azure Metrics</title>
            </Head>
            <SprintTrendsLayout />
        </SidebarDrawerProvider>
    );
                ...
                <Container maxW="full" py={8} px={8}>
                    ...
                    <Flex align="center" mb={10}>
                        <Flex
                            ...
                            mr={4}
                        >
                            <Icon as={MdTrendingUp} boxSize={6} />
                        </Flex>
                        <Box>
                            <Heading size="lg" color={headingColor} letterSpacing="tight">Sprint Trends</Heading>
                            <Text color="gray.500" fontSize="sm">Análise histórica de Cycle Time e Lead Time</Text>
                        </Box>
                    </Flex>
